...
public class EmailUtil {
    ...
    private static final String ORGANIZATION_NAME = "DIDN'T THINK ABOUT NAME";
    ...
    private static final String VERIFYING_ENDPOINT = "http://localhost:8080/api/v1/users/verfiy?token=";
